    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(textoPacienteString != null || riesgoRecurrenteString != null || riesgoProgresoString != null){
                    ...
                    Toast.makeText(getApplicationContext(), "Debe Completar Todos Los Campos Para Continuar" + riesgoProgresoString + riesgoRecurrenteString + textoPacienteString, Toast.LENGTH_SHORT).show();
                }
            }
        });
